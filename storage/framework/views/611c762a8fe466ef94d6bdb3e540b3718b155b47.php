...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?php echo e(asset('fonts/open-sans/styles.css')); ?>"> -->
    ...
    <link class="ks-sidebar-dark-style" rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/styles/themes/sidebar-black.min.css')); ?>">
    <!-- END THEME STYLES -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/styles/apps/crm/roles-permissions.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('libs/summernote/summernote.css')); ?>"> <!-- original -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/styles/libs/summernote/summernote.min.css')); ?>"> <!-- customization -->
</head>
<!-- END HEAD -->
...
<script src="<?php echo e(asset('libs/popper/popper.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('libs/summernote/summernote.min.js')); ?>"></script>
